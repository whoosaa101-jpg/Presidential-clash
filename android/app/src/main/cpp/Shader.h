...
public:
     ...
     * @param modelPositionUniformName The name of your model position uniform
    ...
    static Shader *loadShader(
            ...
            const std::string &modelPositionUniformName);
    ...
    /*!
     * Sets the model position in the shader.
     * @param modelPosition three floats defining the model's position.
     */
    void setModelPosition(const Vector3& modelPosition) const;
...
private:
     ...
     * @param modelPosition the uniform location of the model position
     */
    constexpr Shader(
            GLuint program,
            GLint position,
            ...
            : program_(program),
              ...
              modelPosition_(modelPosition){}

    GLuint program_;
    GLint position_;
    GLint uv_;
    GLint projectionMatrix_;
    GLint modelPosition_;
};
